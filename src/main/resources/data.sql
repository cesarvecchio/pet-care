...
INSERT INTO TB_USUARIO (ID, NOME, EMAIL, SENHA, CEP, LOGRADOURO, COMPLEMENTO, BAIRRO, CIDADE, UF, NUMERO, LATITUDE,
                        LONGITUDE)
VALUES (2, 'PET LOVE', 'admin@petlove.com', 'petlovepasswd', '02525050', 'Avenida Braz Leme', 'Lojas 16 e 17', 'Santana', 'São Paulo', 'SP', '1200',
        -23.507549, -46.648546);
...
INSERT INTO TB_AGENDAMENTO (ID, STATUS, DATA_AGENDAMENTO, OBSERVACAO, PET_ID, PET_SHOP_ID, DONO_ID)
VALUES(1, 1, '2021-06-20 10:00:00', 'Pet do grupo', 1, 2, 1);